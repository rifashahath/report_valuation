            ...
            {files.map((file) => {
                ...
                if (viewMode === 'grid') {
                    return (
                        <div
                            key={file.id}
                            className="bg-white border border-gray-200 rounded-xl p-6 hover:border-brand-300 transition-all shadow-sm hover:shadow-md flex flex-col h-full relative group"
                        >
                    ...
                    return (
                        <div key={file.id} className="group bg-white border border-gray-200 rounded-2xl p-4 hover:border-brand-400 hover:shadow-lg transition-all duration-300 flex items-center justify-between">
